export default class ENV{
    ...
    public static EMPLOYEE_EMAIL = process.env.EMPLOYEE_EMAIL
    public static EMPLOYEE_PWD = process.env.EMPLOYEE_PWD
    public static CLIENT_EMAIL = process.env.CLIENT_EMAIL
    public static CLIENT_PWD = process.env.CLIENT_PWD
