        ...
        if(await this.educationCheck.isVisible()){
            ...
            if(edustatus==="Work In Progress"){
                ...
                if(await this.eduHighSchoolHeader.isVisible()){
                    ...
                    await this.educationProof.setInputFiles("C:/Users/SaikumarVeeramalla/OneDrive - Client Server Technology Solutions LLC/Desktop/Files Dummy/Education1.png")
                ...
                if(await this.eduHigherSecondaryHeader.isVisible()){
                    ...
                    await this.highereducationProof.setInputFiles("C:/Users/SaikumarVeeramalla/OneDrive - Client Server Technology Solutions LLC/Desktop/Files Dummy/Education2.png")
                ...
                if(await this.eduDiplomaHeader.isVisible()){
                    ...
                    await this.dipeducationProof.setInputFiles("C:/Users/SaikumarVeeramalla/OneDrive - Client Server Technology Solutions LLC/Desktop/Files Dummy/EducationDiploma.png")
                ...
                if(await this.eduGraduationHeader.isVisible()){
                    ...
                    await this.ugeducationProof.setInputFiles("C:/Users/SaikumarVeeramalla/OneDrive - Client Server Technology Solutions LLC/Desktop/Files Dummy/EducationUG.png")
                ...
                if(await this.eduPostGraduationHeader.isVisible()){
                    ...
                    await this.pgeducationProof.setInputFiles("C:/Users/SaikumarVeeramalla/OneDrive - Client Server Technology Solutions LLC/Desktop/Files Dummy/EducationPG.png")
